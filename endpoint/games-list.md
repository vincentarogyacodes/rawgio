...
|platforms|integer|Accepts `id` or comma separated `id`s to return a list of games available on specified platform(s). Refer to `GET /tags` to learn about corresponding `id`s and platforms. Also, refer to [Platform Notes](#platforms) for more.|
